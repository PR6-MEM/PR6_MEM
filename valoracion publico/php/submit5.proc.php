...
//Creamos un array de alumnos para meter las notas que genera esta página.
	$alumnos = array($p5_alum1, $p5_alum1, $p5_alum1);
...
//Compruebamos con los echo que nos da los datos que necesitamos para el insert
		...
		$sql_insert = "INSERT INTO `tbl_notas_publico` ( `id_pregunta_publico`, `matricula_alumno_publico`, `valor_nota`, `id_integrante`) VALUES ('5', ".$_SESSION['user'].", ".$alumno.", ".$fila['id_integrante'].")";

		$resultado_insert = mysqli_query($conexion, $sql_insert) or die (mysqli_error());

	}

	header ("location:../valoracion_publico6.php?id_proyecto=$id_proyecto");
