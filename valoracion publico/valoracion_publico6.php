					...
					<!-- internamente el amor=10 sonrio=7 aburro=5 muero=2 -->
						...
						<h3>Contenidos</h3>
							...
							<br>
								...
								<label>
					  				<input type="radio" name="p6_alum1" value="encanta" />
									<img src="img/1.jpg">
								</label>
								<label>
					  				<input type="radio" name="p6_alum1" value="sonrio" />
									<img src="img/2.jpg">
								</label>
								<label>
					  				<input type="radio" name="p6_alum1" value="aburro" />
									<img src="img/3.jpg">
								</label>
								<label>
					  				<input type="radio" name="p6_alum1" value="muero" />
									<img src="img/4.jpg">
								</label>
								<br>		<br>
									<input type="submit" class="btn btn-primary" name="btn_preg6">
						</form>	
						<br>
