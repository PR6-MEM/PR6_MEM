			...
			<div class="row">
				<div class="col-md-12 text-center">
					<!-- internamente el amor=10 sonrio=7 aburro=5 muero=2 -->
						...
						<form class="" action="php/submit6.proc.php">
						<h4>Presentación Oral</h4>
							<h4>Com valores la qualitat del projecte exposat?</h4>
							<br>
								<label>
                                    <input type="radio" name="p6_alum1" value="10" onclick ="seleccionAmarilla_1()"  />
                                    <input type="hidden" name="p6_alum2" value="10" onclick ="seleccionAmarilla_1()"  />
                                    <input type="hidden" name="p6_alum3" value="10" onclick ="seleccionAmarilla_1()"  />
                                    <img src="img/1.jpg" name="cara1">
                                </label>
                                <label>
                                    <input type="radio" name="p6_alum1" value="7" onclick="seleccionAmarilla_1()" />
                                    <input type="hidden" name="p6_alum2" value="7" onclick ="seleccionAmarilla_1()"  />
                                    <input type="hidden" name="p6_alum3" value="7" onclick ="seleccionAmarilla_1()"  />
                                    <img src="img/2.jpg" name="cara1">
                                </label>
                                <label>
                                    <input type="radio" name="p6_alum1" value="4" onclick="seleccionAmarilla_1()"/>
                                    <input type="hidden" name="p6_alum2" value="4" onclick ="seleccionAmarilla_1()"  />
                                    <input type="hidden" name="p6_alum3" value="4" onclick ="seleccionAmarilla_1()"  />
                                    <img src="img/3.jpg" name="cara1">
                                </label>
                                <label>
                                    <input type="radio" name="p6_alum1" value="2" onclick="seleccionAmarilla_1()" />
                                    <input type="hidden" name="p6_alum2" value="2" onclick ="seleccionAmarilla_1()"  />
                                    <input type="hidden" name="p6_alum3" value="2" onclick ="seleccionAmarilla_1()"  />
