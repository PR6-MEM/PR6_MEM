...
<head>
	...
	<script type="text/javascript">
		 ...
		 function seleccionAmarilla_1 (){
            var imagen = document.getElementsByName('p3_alum1');
        ...
        function seleccionAmarilla_2 (){
            var imagen = document.getElementsByName('p3_alum2');
        ...
        function seleccionAmarilla_3 (){
            var imagen = document.getElementsByName('p3_alum3');
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<!-- internamente el amor=10 sonrio=7 aburro=5 muero=2 -->
						...
						<form class="" action="php/submit3.proc.php">
						<h4>Presentación Oral</h4>
							<h4>¿Creus que la presentació està ben estructurada?</h4>
							<br>
								<p> <?php include ("php/consulta_integrante1_proyecto.php");?></p>	
								<label>
					  				<input type="radio" name="p3_alum1" value="10" onclick ="seleccionAmarilla_1()"  />
									<img src="img/1.jpg" name="cara1">
								</label>
								<label>
					  				<input type="radio" name="p3_alum1" value="7" onclick="seleccionAmarilla_1()" />
									<img src="img/2.jpg" name="cara1">
								</label>
								<label>
					  				<input type="radio" name="p3_alum1" value="4" onclick="seleccionAmarilla_1()"/>
									<img src="img/3.jpg" name="cara1">
								</label>
								<label>
					  				<input type="radio" name="p3_alum1" value="2" onclick="seleccionAmarilla_1()" />
									<img src="img/4.jpg" name="cara1">
								</label>
								<br>
								<p><?php include ("php/consulta_integrante2_proyecto.php");?></p>	
								<label>
					  				<input type="radio" name="p3_alum2" value="10" onclick="seleccionAmarilla_2()"/>
									<img src="img/1.jpg" name="cara2">
								</label>
								<label>
					  				<input type="radio" name="p3_alum2" value="7" onclick="seleccionAmarilla_2()" />
									<img src="img/2.jpg" name="cara2">
								</label>
								<label>
					  				<input type="radio" name="p3_alum2" value="4"  onclick="seleccionAmarilla_2()"/>
									<img src="img/3.jpg" name="cara2">
								</label>
								<label>
					  				<input type="radio" name="p3_alum2" value="2" onclick="seleccionAmarilla_2()" />
									<img src="img/4.jpg" name="cara2">
								</label>
								<br>
								<p><?php include ("php/consulta_integrante3_proyecto.php");?></p>	
								<label>
					  				<input type="radio" name="p3_alum3" value="10" onclick="seleccionAmarilla_3()" />
									<img src="img/1.jpg" name="cara3">
								</label>
								<label>
					  				<input type="radio" name="p3_alum3" value="7" onclick="seleccionAmarilla_3()" />
									<img src="img/2.jpg" name="cara3">
								</label>
								<label>
					  				<input type="radio" name="p3_alum3" value="4" onclick="seleccionAmarilla_3()"/>
									<img src="img/3.jpg" name="cara3">
								</label>
								<label>
					  				<input type="radio" name="p3_alum3" value="2" onclick="seleccionAmarilla_3()"/>
